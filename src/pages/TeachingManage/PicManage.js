...
export default class VideoManage extends Component {
  ...
  render() {
    const {teachingManage: {loading: ruleLoading, picData, picItem, classifyAllData}, form: {getFieldDecorator}} = this.props;
          ...
          <Form layout="inline">
            ...
            <FormItem label="分类" {...formItemLayout}>
              {getFieldDecorator('classifyId', {
                  initialValue: addModalType === 'edit' && picItem && picItem.classifyId ? picItem.classifyId : classifyAllData && classifyAllData[0] ? classifyAllData[0].id : '',
                },
              )(
            ...
            <FormItem label="学校图片" {...formItemLayout}>
              {getFieldDecorator('thumbnailResourceId', {
                  initialValue: addModalType === 'edit' && picItem && picItem.thumbnailResourceId ? picItem.thumbnailResourceId : '',
                  rules: [{
                    required: true,
                    message: '学校图片',
                  }],
                ...
                <Upload
                  ...
                  {imageUrl ?
                    <img src={imageUrl} alt="avatar"/> : addModalType === 'edit' && picItem && picItem.thumbnailUrl ?
                      <img src={picItem.thumbnailUrl} alt="avatar"/> : <div>
