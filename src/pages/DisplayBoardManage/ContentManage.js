...
export default class ContentManage extends Component {
  ...
  renderForm() {
    const {displayBoardManage: {classifyDisplayAll}} = this.props;
    let recourseObj = [];
  ...
  render() {
    const {displayBoardManage: {loading: ruleLoading, contentDisplayData, contentDisplayItem, classifyDisplayAll, items}, form: {getFieldDecorator}} = this.props;

    const {addVisible, addModalTitle, addModalType, itemId, itemDetails, resourceData, uploading} = this.state;
    console.log(resourceData)
